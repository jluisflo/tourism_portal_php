<?php 
    ...
    $con=conectar();
    $consulta=mysqli_query($con,"select * from tb_usuarios where u_tipoCuenta='administrador'");
...
<head>
    ...
    <title>Usuarios Administradores - Administrador</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Usuarios Administradores Registrados</h1>
                            ...
                            <div class="panel-body">
                                <div class="form-inline section">
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                  <a href="../reportes/reporteusuarios.php" class="btn btn-primary" target="_blank" onClick="window.open(this.href, this.target, 'width=800,height=600'); return false;">Generar Reporte</a>
                                  </div>
...
<form enctype="multipart/form-data" id="form-destino" action="../script/admin/mantenimientoadmin.php" method="POST" class="modal fade" tabindex="-1" role="dialog">
