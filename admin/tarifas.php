<?php 
    ...
    $con=conectar();
    $consulta=mysqli_query($con,"select * from tb_tarifa");
...
<head>
    ...
    <title>Tarifas - Administrador</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tipo de Tarifas Registradas</h1>
                        ...
                        <td>
                            ...
                            onclick="pasarDatos('<?php echo $row['idTarifa']; ?>','<?php echo $row['nombre']; ?>')">
                        </td>
                        <td><?php echo $row['idTarifa']; ?></td> 
    ...
    <form enctype="multipart/form-data" id="form-destino" action="../script/admin/mantenimientotarifas.php" method="POST" class="modal fade" tabindex="-1" role="dialog">
