...
?>
 <div class="section blue center">
  <h3 class="white-text light">Valor a pagar: <strong class="amber-text">$<?php echo $pagar; ?></strong></h3>
</div> 
<div class="container">
<form id="frmPago" method="POST" action="../script/user/guardarcompra.php">
  <input style="display: none" type="text" name="monto" value="<?php echo $pagar; ?>">
  <div class="section">
   <h5>Información de Comprador<h5>
   <div class="section">
   <div class="row">
    <div class="col s12 m4 l4">
      <label>Departamento/Provincia:</label>
      <input type="text" name="depar">    
    </div>
    <div class="col s12 m4 l4">
      <label>Ciudad:</label>
   ...
   <div class="row">
    ...
    <label>Seleccionar pais</label>
      <select name="pais" class="browser-default">
  ...
  <div class="section">
    ...
    <p>Todas las trasacciones son seguras y encriptadas. </p>
    <div class="section">
    ...
    <div class="row">
      <div class="input-field col s12 m8 l8">
          ...
          <small>Ejemplo: 6011775163164792</small>
      </div>
    ...
    <div class="row">
      ...
      <div class="input-field col s12 m4 l4">
          ...
          <label>CCV codigo:</label>      
      </div>
    </div>

    <div class="row">
      <div class="input-field col s12 m5 l5">
          <input type="text" name="venci">
          <label>Fecha de Expiracion:</label>  
          <small>FORMATO: mes/año, <strong>EJEMPLO: 08/2017</strong></small>      
      </div>
    </div>
    </div>
  ...
  <div class="center">
    <input type="submit" class="btn btn-large green" value="Efectuar Compra">
  </div>
</form>
<br>
  </div>
...
<script type="text/javascript">
  ...
  "Debe ser una fecha de caducidad válida"
  );
