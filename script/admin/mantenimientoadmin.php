...
switch ($_POST['operacion']){
	case 'Insertar':
		...
		$sqlAgregar = mysqli_query($con, "INSERT INTO tb_usuarios(u_nombre,u_apellido,u_usuario,u_clave, u_tipoCuenta) VALUES('$nombre','$apellido','$usuario','$clave','administrador')");
